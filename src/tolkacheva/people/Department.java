...
public class Department {
    ...
    public void setBoss(Worker worker){
        if (!workerList.contains(worker)) throw new IllegalArgumentException("Person isn't worker of tolkacheva.people.Department");
        this.boss = worker;
    }
    ...
    public String toString(){ return "tolkacheva.people.Department of " + name;}
}
